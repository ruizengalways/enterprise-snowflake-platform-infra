output "project_deploy_service_users" {
  description = "Project UAT deployment Snowflake SERVICE users keyed by project key."
  value = {
...
output "project_deploy_roles" {
  description = "Existing project DEPLOY roles bound to UAT deployment service users."
  value = {
    for project_key, identity in module.project_deploy_identity :
...
output "project_deploy_oidc_subjects" {
  description = "GitHub OIDC subjects trusted by UAT project deployment service users."
  value = {
    for project_key, identity in module.project_deploy_identity :
